...
namespace ProgrammersLiveShow.Migrations
{
    ...
    [Migration("20170311133514_update_shopsize")]
    partial class update_shopsize
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Pls.Entity.OrderDetailEntity", b =>
                {
                    ...
                    b.Property<int>("orderdetail_delete")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(1);

                    b.Property<int>("orderdetail_evaluate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("Pls.Entity.ShopAttrEntity", b =>
                {
                    ...
                    b.Property<double>("shopattr_size");
            ...
            modelBuilder.Entity("Pls.Entity.UserApplyEntity", b =>
                {
                    b.Property<string>("apply_id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("apply_desc")
                        .HasAnnotation("MaxLength", 100);
                    ...
                    b.HasAnnotation("MySql:TableName", "Pls_User_Apply");
                });
