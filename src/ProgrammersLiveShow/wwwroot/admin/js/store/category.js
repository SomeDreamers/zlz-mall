...
pls.admin.category = (function () {

    var defaults = {
        listUrl: "/Admin/Category/List",
        childListUrl: "/Admin/Category/ChildList",
    ...
    var columns = [{
        ...
        formatter: function (value, rows, index) {
            return '<div id="action_name_' + rows.id + '">' + value + '</div>';
        }
    }, {
        title: '分类类型',
        field: 'action_type',
        ...
        formatter: function (value, rows, index) {
            value = value || "/";
            return '<div id="action_weight_' + rows.action_id + '">' + value + '</div>';
        }
    }]
    var setting = {
        view: {
